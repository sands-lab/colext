...
from .scrapper.psutil_scrapper import PSUtilScrapper
...
def get_scrapper_agent_for_dev() -> ScrapperBase:
    ...
    if "Jetson" in dev_type:
        from .scrapper.jetson_scapper import JetsonScrapper
        scrapper_agent = JetsonScrapper
    elif "LattePanda" in dev_type:
        from .scrapper.latte_scapper import LatteScrapper
        scrapper_agent = LatteScrapper
