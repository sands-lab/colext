...
class FedAdam(FedOpt):
    ...
    def aggregate_fit(
        ...
        fedavg_weights_aggregate = self.parameters_to_ndarrays(fedavg_parameters_aggregated)

        if self.current_weights is None:
            self.current_weights = self.parameters_to_ndarrays(fedavg_parameters_aggregated)
        ...
        return self.ndarrays_to_parameters(self.current_weights), metrics_aggregated
